    ...
    const validateJoinCode = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `/api/classes/verify/${joinCodeValue.toUpperCase()}`,
        );
    ...
    <>
      <div style={styles.container}>
        ...
        <form style={styles.form} onSubmit={handleSubmit(onSubmit)}>
          ...
          {errMsg && <div style={styles.errorMessage}>{errMsg}</div>}

          <div className="mb-3">
            <label htmlFor="joinCode" style={styles.formLabel}>
              Join Code
            </label>
            ...
            {errors.joinCode && (
              <span className="text-danger">{errors.joinCode.message}</span>
            )}
            ...
            <input
              ...
              {...register("fullName", {
                ...
                pattern: {
                  ...
                  message:
                    "Full Name must only contain letters and spaces, and cannot end with a space",
                },
              })}
              maxLength={50}
            />
            ...
            <input
              ...
              {...register("email", {
                ...
                pattern: {
                  ...
                  message:
                    "Email must be a valid NSCC email (e.g., w0000000@nscc.ca)",
                },
              })}
              maxLength={50}
            />
          ...
          <div className="mb-3">
            <label htmlFor="studentNumber" style={styles.formLabel}>
              Student Number
            </label>
            <input
              type="text"
              ...
              {...register("studentNumber", {
                ...
                pattern: {
                  value: /^w\d{7}$/,
                  message:
                    "Student Number must start with 'w' (lowercase) followed by 7 digits (e.g., w1234567)",
                },
              })}
            />
